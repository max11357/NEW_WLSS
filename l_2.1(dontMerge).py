...
def distance_candidate(cch, pkt_control, elec_tran, elec_rec, fs, mpf, d_threshold, r1):
    cluster_member = []
...
def start():
    ...
    distance_candidate(cch, pkt_control, elec_tran, elec_rec, fs, mpf, d_threshold, r1)
