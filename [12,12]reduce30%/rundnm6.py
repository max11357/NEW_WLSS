...
def e_distance_candidate(cch, pkt_control, elec_tran, elec_rec, fs, mpf, \
                         d_threshold, dead, r1, dead_point):
...
def e_optimize_t(cluster_head, cluster_member, cm_select, max_distance, r1, pkt_data,\
               pkt_control, elec_tran, elec_rec, fs, mpf, d_threshold, dead, dead_point):
    if dead == 0:
        ...
        for d in max_distance:
            ...
            if  d[1] < d_threshold :
                ...
                if cluster_head[d[0]][2] - e_tx  > 0:
                    ...
                    dead_point = cluster_head[d[0]]
                    dead_point.append(' ch send optimize')
                    dead = 1
            else:
                ...
                if cm_select[cm][0] == d[0]:
                    ...
                    if d[1] != 0:
                        if cluster_member[cm][2] - e_rx > 0:
                            ...
                            dead_point = cluster_head[d[0]]
                            dead_point.append('cm send optimize')
                            dead = 1
...
def start(width, height, density, num_base, pos_base, set_energy, pkt_control, pkt_data, \
    ...
    while True:
        ...
        cluster_head, cluster_member, dead, dead_point = \
        e_optimize_t(cluster_head, cluster_member, cm_select, max_distance, r1, pkt_data, pkt_control, elec_tran, elec_rec, fs, mpf, d_threshold, dead, dead_point)
