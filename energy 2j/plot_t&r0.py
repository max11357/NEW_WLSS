...
def dfix_1(fix_1):
    count, r, avg_rfix1, r0_f1 = 0, 0, [],[]
    for index in range(len(fix_1)-1):
        r0_f1.append(float("%.2f"%fix_1[index][2]))
...
##                count, r = 0, 0
    ...
    for i in r0_f1:
        if 29 <= i and i <= 31:
            mean_c += 1
    plt.hist(r0_f1, bins=60, \
             label = 'operation cluster size \n between 29-31 meter is '+\
             str("%.2f"%float(mean_c/len(r0_f1)*100))+'%')
    plt.legend()
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.xlabel('fix with t predefine 0.1')
    plt.show()
    return avg_rfix1

def dfix_2(fix_2):
    count, r, avg_rfix2,r0_f2 = 0, 0, [],[]
    for index in range(len(fix_2)-1):
        r0_f2.append(float("%.2f"%fix_2[index][2]))
...
##                count, r = 0, 0
    ...
    for i in r0_f2:
        if 29 <= i and i <= 31:
            mean_c += 1
    plt.hist(r0_f2, bins=60, \
             label = 'operation cluster size \n between 29-31 meter is '+\
             str("%.2f"%float(mean_c/len(r0_f2)*100))+'%')
    plt.legend()
    plt.ylim(0,120000)
    plt.xlabel('fix with t predefine 0.2')
    plt.show()
    return avg_rfix2
...
def dfix_3(fix_3):
    ...
    for index in range(len(fix_3)-1):
        r0_f2.append(float("%.2f"%fix_3[index][2]))
...
##                count, r = 0, 0
    ...
    plt.hist(r0_f2, bins=60, \
             ...
             str("%.2f"%float(mean_c/len(r0_f2)*100))+'%')
    plt.legend()
    plt.xlabel('fix with t predefine 0.3')
    plt.show()
    return avg_rfix3
...
def dfix_4(fix_4):
    ...
    for index in range(len(fix_4)-1):
        r0_f2.append(float("%.2f"%fix_4[index][2]))
...
##                count, r = 0, 0
    ...
    plt.hist(r0_f2, bins=60, \
             ...
             str("%.2f"%float(mean_c/len(r0_f2)*100))+'%')
    plt.legend()
    plt.xlabel('fix with t predefine 0.4')
    plt.show()
    return avg_rfix4
...
def dfix_5(fix_5):
    ...
    for index in range(len(fix_5)-1):
        r0_f2.append(float("%.2f"%fix_5[index][2]))
...
##                count, r = 0, 0
    ...
    plt.hist(r0_f2, bins=60, \
             ...
             str("%.2f"%float(mean_c/len(r0_f2)*100))+'%')
    plt.legend()
    plt.xlabel('fix with t predefine 0.5')
    plt.show()
    return avg_rfix5
...
def dfix_6(fix_6):
    ...
    for index in range(len(fix_6)-1):
        r0_f2.append(float("%.2f"%fix_6[index][2]))
...
##                count, r = 0, 0
    ...
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.xlabel('fix with t predefine 0.6')
    plt.show()
    return avg_rfix6
...
def dfix_7(fix_7):
    ...
    for index in range(len(fix_7)-1):
        r0_f2.append(float("%.2f"%fix_7[index][2]))
...
##                count, r = 0, 0
    ...
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.xlabel('fix with t predefine 0.7')
    plt.show()
    return avg_rfix7
...
def dfix_8(fix_8):
    ...
    for index in range(len(fix_8)-1):
        r0_f2.append(float("%.2f"%fix_8[index][2]))
...
##                count, r = 0, 0
    ...
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.xlabel('fix with t predefine 0.8')
    plt.show()
    return avg_rfix8
...
def dfix_9(fix_9):
    ...
    for index in range(len(fix_9)-1):
        r0_f2.append(float("%.2f"%fix_9[index][2]))
...
##                count, r = 0, 0
    ...
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.xlabel('fix with t predefine 0.9')
    plt.show()
    return avg_rfix9
...
def dynamic_1(dyn_1):
    ...
    for index in range(len(dyn_1)-1):
        r0_f1.append(float("%.2f"%dyn_1[index][3]))
...
##                count, t, r = 0,0, 0
    ...
    plt.hist(r0_f1, bins=60, \
             ...
             str("%.2f"%float(mean_c/len(r0_f1)*100))+'%')
    plt.legend()
    plt.xlabel('dynamic with t predefine 0.1')
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.show()
...
def dynamic_2(dyn_2):
    ...
    for index in range(len(dyn_2)-1):
        r0_f1.append(float("%.2f"%dyn_2[index][3]))
...
##                count, t, r = 0,0, 0
    ...
    plt.hist(r0_f1, bins=60, \
             ...
             str("%.2f"%float(mean_c/len(r0_f1)*100))+'%')
    plt.legend()
    plt.xlabel('dynamic with t predefine 0.2')
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.show()
...
def dynamic_3(dyn_3):
    ...
    for index in range(len(dyn_3)-1):
         r0_f1.append(float("%.2f"%dyn_3[index][3]))
...
##                count, t, r = 0,0, 0
    ...
    plt.hist(r0_f1, bins=60, \
             ...
             str("%.2f"%float(mean_c/len(r0_f1)*100))+'%')
    plt.legend()
    plt.xlabel('dynamic with t predefine 0.3')
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.show()
...
def dynamic_4(dyn_4):
    ...
    for index in range(len(dyn_4)-1):
        r0_f1.append(float("%.2f"%dyn_4[index][3]))
...
##                count, t, r = 0,0, 0
    ...
    plt.hist(r0_f1, bins=60, \
             ...
             str("%.2f"%float(mean_c/len(r0_f1)*100))+'%')
    plt.legend()
    plt.xlabel('dynamic with t predefine 0.4')
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.show()
...
def dynamic_5(dyn_5):
    ...
    for index in range(len(dyn_5)-1):
        r0_f1.append(float("%.2f"%dyn_5[index][3]))
...
##                count, t, r = 0,0, 0
    ...
    plt.hist(r0_f1, bins=60, \
             ...
             str("%.2f"%float(mean_c/len(r0_f1)*100))+'%')
    plt.legend()
    plt.xlabel('dynamic with t predefine 0.5')
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.show()
...
def dynamic_6(dyn_6):
    ...
    for index in range(len(dyn_6)-1):
        r0_f1.append(float("%.2f"%dyn_6[index][3]))
...
##                count, t, r = 0,0, 0
    ...
    plt.hist(r0_f1, bins=60, \
             ...
             str("%.2f"%float(mean_c/len(r0_f1)*100))+'%')
    plt.legend()
    plt.xlabel('dynamic with t predefine 0.6')
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.show()
...
def dynamic_7(dyn_7):
    ...
    for index in range(len(dyn_7)-1):
        r0_f1.append(float("%.2f"%dyn_7[index][3]))
...
##                count, t, r = 0,0, 0
    ...
    plt.hist(r0_f1, bins=60, \
             ...
             str("%.2f"%float(mean_c/len(r0_f1)*100))+'%')
    plt.legend()
    plt.xlabel('dynamic with t predefine 0.7')
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.show()
...
def dynamic_8(dyn_8):
    ...
    for index in range(len(dyn_8)-1):
        r0_f1.append(float("%.2f"%dyn_8[index][3]))
...
##                count, t, r = 0,0, 0
    ...
    plt.hist(r0_f1, bins=60, \
             ...
             str("%.2f"%float(mean_c/len(r0_f1)*100))+'%')
    plt.legend()
    plt.xlabel('dynamic with t predefine 0.8')
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.show()
...
def dynamic_9(dyn_9):
    ...
    for index in range(len(dyn_9)-1):
        r0_f1.append(float("%.2f"%dyn_9[index][3]))
...
##                count, t, r = 0,0, 0
    ...
    plt.hist(r0_f1, bins=60, \
             ...
             str("%.2f"%float(mean_c/len(r0_f1)*100))+'%')
    plt.legend()
    plt.xlabel('dynamic with t predefine 0.9')
    plt.ylim(0,120000)
    plt.xlim(0,60)
    plt.show()
...
def plot(avg_t1, avg_r01, avg_t2, avg_r02,avg_t3, avg_r03, avg_t4, avg_r04,\
    ...
    plt.plot(avg_t1, label ='t predefine 0.1 averge is '+str("%.2f"%float((mean(avg_t1[400:600])))))
    plt.plot(avg_t2, label ='t predefine 0.2 averge is '+str("%.2f"%float((mean(avg_t2[400:600])))))
    plt.plot(avg_t3, label ='t predefine 0.3 averge is '+str("%.2f"%float((mean(avg_t1[400:600])))))
    plt.plot(avg_t4, label ='t predefine 0.4 averge is '+str("%.2f"%float((mean(avg_t4[400:600])))))
    plt.plot(avg_t5, label ='t predefine 0.5 averge is '+str("%.2f"%float((mean(avg_t5[400:600])))))
    plt.plot(avg_t6, label ='t predefine 0.6 averge is '+str("%.2f"%float((mean(avg_t6[400:600])))))
    plt.plot(avg_t7, label ='t predefine 0.7 averge is '+str("%.2f"%float((mean(avg_t7[400:600])))))
    plt.plot(avg_t8, label ='t predefine 0.8 averge is '+str("%.2f"%float((mean(avg_t8[400:600])))))
    plt.plot(avg_t9, label ='t predefine 0.9 averge is '+str("%.2f"%float((mean(avg_t9[400:600])))))
    plt.xlabel('round')
