...
def back_to_nodes(cluster_member, node_member, max_dis, r1, t_predefine, choose, i, count_lap):
...
def back_to_nodes_dynamic(cluster_member, node_member, max_dis, r1, t_predefine, i, count_lap):
    """ before next loop all cluster switch back to node_member """
    # collect data highest distance from each cluster
    data =[]
    for j in max_dis:
            ...
            if int(choose) == 0:
                ...
                for t in set_t_value:
                    ...
                    while True:
                        ...
                        cluster_member_last, node_member = \
                            back_to_nodes(cluster_member, node_member, max_dis, r1, \
                            t_predefine, choose,i, count_lap)
                ...
                while True:
                    ...
                    cluster_member_last, node_member = \
                        back_to_nodes_dynamic(cluster_member, node_member, max_dis, r1, t_predefine, i,count_lap)
