...
##    ai = [ i for i in a]
##    
##    plt.plot(ai,keepf, marker='o', label='Minimum Cluster')
##    plt.plot(ai,keepd, marker='o', label='Minimum Cluster')
