...
def become_ch(cch, r1, cluster_member, dead, cm_original, super_round):
...
def comp(cch, r1, cluster_member, dead, cm_original, me_ch, me_not, len_cm):
    cluster_head = []
    me_ch2 = []
    me_not2 = []
    ...
    for ch in me_ch2:
        ...
        with open('cluster data.csv', 'a', newline='') as csvnew:
            write = csv.writer(csvnew)
            for line in [ch]:
                write.writerow(line)
...
def start(width, height, density, num_base, pos_base, set_energy, pkt_control, pkt_data, \
    ...
    while True:
        ...
        if check_super_round == 0:
            ...
            me_ch, me_not = become_ch(cch, r1, cluster_member, dead, cm_original, super_round)


            cluster_head, cluster_member, dead, cm_original = \
            comp(cch, r1, cluster_member, dead, cm_original, me_ch, me_not , len_cm)
