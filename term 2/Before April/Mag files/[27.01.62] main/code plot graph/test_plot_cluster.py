...
def append_data_n_plot(len_cluster, f_d, num, max_list, mean_list, min_list):
    ...
    # X = range(1,101)
    plt.axis([1, 70, 0, max(max_f)+max(max_f)/4])
    X = range(1,71)
...
def run():
    ...
    line1 = plt.plot(xi, min_list[0:1], marker='o', label='Minimum Cluster')
    line2 = plt.plot(xi, mean_list[0:1], marker='o', label='Average Cluster is')
    line3 = plt.plot(xi, max_list[0:1], marker='o',label='Maximum Cluster')
    plt.ylim(0,15)
    plt.legend()
    ...
    line1 = plt.plot(xi, min_list[1:], marker='o', label='Minimum Cluster')
    line2 = plt.plot(xi, mean_list[1:], marker='o', label='Average Cluster is')
    line3 = plt.plot(xi, max_list[1:], marker='o',label='Maximum Cluster')
    plt.ylim(0,15)
    plt.legend()
    plt.show()
    ...
    plt.plot(xi, mean_list[:1], marker='o', label='Fix Average Cluster ')
    plt.plot(xi, mean_list[1:], marker='o', label='Dynamic Average Cluster ')
    plt.legend()
    plt.show()
