...
def base_bs(num_base, pos_base, t_value, super_round, false_values):
    """input bs point"""
    # Set POS bs here
    bs_member = []
    ...
    with open('bs_memberD'+str(t_value*10)+"_"+str(super_round)+"_"+str(false_values)+'.csv', 'w', newline='') as csvnew:
...
def random_cm(width, height, bs_member, set_energy, density, t_value, super_round, false_values):
    """random cm"""
    # Random cm
    cm_original = []
    ...
    while len(cm_original) != len_cm:
        ...
        count += 1
    # append data to csv. file
    with open('cm_originalD'+str(t_value*10)+"_"+str(super_round)+"_"+str(false_values)+'.csv', 'w', newline='') as csvnew:
        write = csv.writer(csvnew)
        for line1 in cm_original:
            write.writerow(line1)
    with open("len_cmD"+str(t_value*10)+"_"+str(super_round)+"_"+str(false_values)+".txt", "w") as text_file:
...
def check_data(cluster_head, cluster_member, at1, at2, at3, at4, at5, at6, \
                ...
                at16, at17, at18, at19, t_value, cache, collect_envi, cm_select, count_sr, false_values):
    send_or_not = []
    check_super_round = 1
    ...
    if count_sr == 0:
        for cm in range(len(cluster_member)):
            ...
            # print(cluster_member[cm][4], eval('at%d'% (cluster_member[cm][4]))[0][cache])
    else:
        for cm in range(len(cluster_member)):
            ...
            for cec in collect_envi:
                if cluster_head[ch][5] == cec[0]:
                    ...
                    if diff > false_values:
                        ...
                        # print(cluster_head[ch][5], cluster_head[ch][2])
    # for i in cluster_head:print(i[5])
    # print(" ")
    # for i in cluster_member:print(i[5])
    # print(" ")
    # for i in collect_envi: print(i)
    # print("-----------------")
    cache += 1
...
def back_to_cm_dynamic(cluster_head, cluster_member, max_distance, r1, t_value, count_lap, \
                    ...
                    check_super_round, super_round, count_sr, check_optimize_t, \
                    cache, collect_envi, false_values):
    ...
    if dead == 0:
        ...
        with open('data t dynamic '+str(t_value)+"_"+str(super_round)+"_"+str(false_values)+' and r0.csv', 'a', newline='') as csvnew:
            write = csv.writer(csvnew)
            for line1 in log1:
                write.writerow(line1)

        log2= [[count_lap, len(cluster_head), count_ch_member, len_cm, len_cm-cm_out_of_range]]
        with open('data cluster dynamic '+str(t_value)+"_"+str(super_round)+"_"+str(false_values)+'.csv', 'a', newline='') as csvnew:
            write = csv.writer(csvnew)
            for line in log2:
                write.writerow(line)
...
def start(width, height, density, num_base, pos_base, set_energy, pkt_control, pkt_data, \
          d_threshold, r1, r2, decimal, decrease_t, increase_t, false_values, dead_round):
    ...
    bs_member = \
    base_bs(num_base, pos_base, t_value, super_round, false_values)


    cm_original, len_cm = \
    random_cm(width, height, bs_member, set_energy, density, t_value, super_round, false_values)
    ...
    cm_original = []
    with open("bs_memberD"+str(t_value*10)+"_"+str(super_round)+"_"+str(false_values)+".csv", 'r') as csvnew:
        read = csv.reader(csvnew)
        for line1 in read:
            bs_member.append(list(map(int, line1)))
    with open("cm_originalD"+str(t_value*10)+"_"+str(super_round)+"_"+str(false_values)+".csv", 'r') as csvnew:
        read = csv.reader(csvnew)
        for line2 in read:
            cm_original.append(list(map(float, line2)))
    
    while True:
        with open("len_cmD"+str(t_value*10)+"_"+str(super_round)+"_"+str(false_values)+".txt", "r") as text_file:
        ...
        check_data(cluster_head, cluster_member, at1, at2, at3, at4, at5, at6, \
            ...
            at19, t_value, cache, collect_envi, cm_select, count_sr, false_values)
        ...
        if dead == 0:
            ...
            with open('used energy dmn '+str(t_value)+"_"+str(super_round)+"_"+str(false_values)+'.csv', 'a', newline='') as csvnew:
            ...
            with open('dead point dmn '+str(t_value)+"_"+str(super_round)+"_"+str(false_values)+'.csv', 'a', newline='') as csvnew:
                write = csv.writer(csvnew)
                for line in dead_point:
                    write.writerow(line)
            log3 = [[t_value, count_lap]]
            with open('count lap dynamic '+str(t_value)+"_"+str(super_round)+"_"+str(false_values)+'.csv', 'a', newline='') as csvnew:
                write = csv.writer(csvnew)
                for line in log3:
                    write.writerow(line)
            break
