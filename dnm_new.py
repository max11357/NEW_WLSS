...
def let_node_selected(cluster_member, node_member, r2, data_distance, dead):
    ...
    return data_distance, node_select, max_dis, log_c_select, dead, cluster_select, amount_n_with_c
...
def start(width, height, density, num_base, pos_base, set_energy, pkt_control, pkt_data, \
    ...
    while True:
        ...
        data_distance, node_select, max_dis, log_c_select, dead, cluster_select, amount_n_with_c = \
