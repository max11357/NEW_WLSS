...
def plot(count_1, count_2, count_3, count_4, count_5, count_6, count_7, count_8, count_9,\
    ...
    dmn_min = [min(dyn_1),min(dyn_2),min(dyn_3),min(dyn_4),min(dyn_5),\
    ...
    dmn_mean = [mean(dyn_1),mean(dyn_2),mean(dyn_3),mean(dyn_4),mean(dyn_5),\
    ...
    dmn_max = [max(dyn_1),max(dyn_2),max(dyn_3),max(dyn_4),max(dyn_5),\
    ...
    plt.xticks(ind + width , ('fix 0.1', 'fix 0.2', 'fix 0.3', 'fix 0.4', 'fix 0.5', \
                                 'fix 0.6', 'fix 0.7', 'fix 0.8', 'fix 0.9'), size=8)
    plt.ylabel('Rounds')
    ...
    bar_1 = plt.bar(ind, dmn_max, width, label =' Maximum round')
    plt.plot()
    bar_2 = plt.bar(ind + width, dmn_mean, width,  label =' Average round')
    bar_3 = plt.bar(ind + width + width, dmn_min, width, label =' Minimum round')
    plt.xticks(ind + width , ('dmn 0.1', 'dmn 0.2', 'dmn 0.3', 'dmn 0.4', 'dmn 0.5', \
                                 'dmn 0.6', 'dmn 0.7', 'dmn 0.8', 'dmn 0.9'), size=8)
    plt.ylabel('Rounds')
